...
// creare JSON di mock per simulare il dato in arrivo dal front end
export const RECIPES: IRecipe[] = [
  {
    _id: 1,
    title: 'Cannelloni',
    description:
      'Un piatto classico italiano, perfetto per i pranzi in famiglia.',
  ...
  },
  {
    ...
    title: 'Spaghetti',
    description:
      'Il classico piatto di spaghetti al pomodoro, semplice e gustoso.',
  ...
  },
  {
    ...
    title: 'Ciambelle',
    description:
      'Dolci ciambelle fritte, ideali per la colazione o la merenda.',
  ...
  },
  {
    _id: 4,
    title: 'Insalata',
    description: 'Un’insalata fresca e leggera per ogni occasione.',
    image:
